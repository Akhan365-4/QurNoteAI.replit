// First page of each surah in the standard Medina Mushaf (604 pages).
// Format: [surahNumber, firstQuranPage]
// Used to resolve a Quran page → surah for navigation.
const SURAH_FIRST_PAGES: [number, number][] = [
...
/**
 * Given a Quran page number (1–604), returns the surah number that
 * contains that page. Uses the last surah whose first page ≤ target.
 */
export function pageToSurah(page: number): number {
  let result = 1;
  for (const [surah, firstPage] of SURAH_FIRST_PAGES) {
